...
from ..forms import CSVDefinitionForm, ExportForm, ImportUploadForm
from ..lib import import_csv, import_firefly
from ..models import ImportConfiguration, ImportFile, Split
...
class ImportConfigureView(LoginRequiredMixin, generic.CreateView):
    ...
    template_name = 'finance/import_configure.html'
...
class ImportProcessView(LoginRequiredMixin, generic.TemplateView):
    template_name = 'finance/import_process.html'
...
class ExportView(LoginRequiredMixin, generic.edit.FormView):
    template_name = 'finance/export.html'
