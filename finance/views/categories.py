...
from ..forms import CategoryAssignFormset
from ..lib import last_day_of_month
from ..models import Account, Category, Split


class CategoryIndex(LoginRequiredMixin, generic.TemplateView):
    template_name = 'finance/category_index.html'
...
class InactiveCategoriesView(LoginRequiredMixin, generic.ListView):
    model = Category
    template_name = 'finance/inactive_categories.html'
...
def assign_categories(request):
    ...
    return render(request, 'finance/category_assign.html',
