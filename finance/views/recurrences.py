...
from ..forms import DepositForm, RecurringTransactionForm, TransferForm, WithdrawForm
...
class RecurringTransactionIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'finance/recurring_transactions.html'
...
class DisabledRecurrencesView(LoginRequiredMixin, generic.ListView):
    template_name = 'finance/disabled_recurrences.html'
