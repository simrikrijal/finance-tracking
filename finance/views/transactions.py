...
from ..forms import DepositForm, TransactionFormSet, TransferForm, WithdrawForm
...
class TransactionIndex(LoginRequiredMixin, generic.ListView):
    template_name = 'finance/transaction_overview.html'
...
class SplitCreate(LoginRequiredMixin, generic.edit.CreateView):
    model = Transaction
    template_name = 'finance/transaction_split_form.html'
