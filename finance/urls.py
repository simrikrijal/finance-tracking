...
from .views import budgets as budget_views
from .views import categories as category_views
from .views import charts as chart_views
from .views import imports as import_views
from .views import index as general_views
from .views import recurrences as recurrence_views
...
urlpatterns = [
    ...
    path('manifest.json', TemplateView.as_view(template_name='finance/manifest.json'),
         name='manifest'),
